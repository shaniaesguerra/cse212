...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue is adding person in front of the list instead of at the end.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Not checking in GetNextPerson() for values equal to zero
    //                  not enqueing the person correctly
    ...
    // Defect(s) Found: Not checking in GetNextPerson() for values less than zero resulting to 
    //                  not enqueing the person correctly
    ...
    // Defect(s) Found: No Defects found. Works as expected
