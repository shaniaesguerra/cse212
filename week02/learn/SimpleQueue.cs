public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Removing data from index 1 rather than 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Values are being added to the front of the queue using Enqueue function
        ...
        // Defect(s) Found: Works as expected, no defects found
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Defect 2 - add to the end of the queue instead
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Defect 1 - starting index should be 0
        _queue.RemoveAt(0);
        return value;
    }
}